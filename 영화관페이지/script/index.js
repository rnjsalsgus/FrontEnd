document.addEventListener("DOMContentLoaded", () => {
  ...
  for (let i = 1; i <= 5; i++) {
    ...
    inbox[i - 1].style.backgroundSize = "100% 774px";
  ...
  for (let i = 1; i <= 8; i++) {
    ...
    movieImg[i - 1].style.backgroundSize = "100% 320px";
  ...
  for (let i = 0; i <= 8; i++) {
    movieContainers[i].addEventListener("mouseover", () => {
      reserveBoxs[i].style.display = "block";
    });
    movieContainers[i].addEventListener("mouseout", () => {
